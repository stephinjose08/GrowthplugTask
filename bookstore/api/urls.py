...
genreViewSet,ebookCreateView,ebookupdatedeleteView,EbookActionsView,genreActionsView,genreupdatedeleteView,genreCreateView)
...
urlpatterns = [
    ...
    path('create_genre/', genreCreateView.as_view() ,name='book-create'),
    ...
    path('ebookactions/', EbookActionsView.as_view() ,name='search-filter-order-Ebook'),
    path('genreactions/', genreActionsView.as_view() ,name='searchfilter-order-Genre'),
]